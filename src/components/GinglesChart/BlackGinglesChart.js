...
const BlackAssemblyScatterPlot = ({ selectedState, showChart }) => {
  ...
  const scenario = `${statecode}_BLACK`;
  const filter = "black";
      ...
      <Scatter
        ...
        options={{
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: `${selectedState} Black Vote Share by Precinct`,
            },
            legend: { display: true },
          },
          scales: {
...
export default BlackAssemblyScatterPlot;
