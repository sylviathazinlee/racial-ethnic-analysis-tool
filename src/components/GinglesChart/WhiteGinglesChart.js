...
const WhiteAssemblyScatterPlot = ({ selectedState, showChart }) => {
  ...
  const scenario = `${statecode}_WHITE`;
  const filter = "white";
      ...
      <Scatter
        ...
        options={{
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: `${selectedState} White Vote Share by Precinct`,
            },
            legend: { display: true },
          },
          scales: {
...
export default WhiteAssemblyScatterPlot;
