...
const HispanicAssemblyScatterPlot = ({ selectedState, showChart }) => {
  ...
  const scenario = `${statecode}_HISPANIC`;
  const filter = "hispanicLatino";
      ...
      <Scatter
        ...
        options={{
          ...
          plugins: {
            ...
            title: {
              display: true,
              text: `${selectedState} Hispanic Vote Share by Precinct`,
            },
            legend: { display: true },
          },
          scales: {
...
export default HispanicAssemblyScatterPlot;
