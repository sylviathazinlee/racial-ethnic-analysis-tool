...
import NYEnsembleData from "./ensemble_results_NY_250.json";
import SCEnsembleData from "./ensemble_results_SC_250.json";

const EnsembleSum250 = ({ selectedState, showTable }) => {
